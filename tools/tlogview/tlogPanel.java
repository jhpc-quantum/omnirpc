// $Id: tlogPanel.java,v 1.1.1.1 2004-11-03 21:01:38 yoshihiro Exp $
// $RWC_Release$
// $RWC_Copyright$
...
class tlogDrawPanel extends Panel {
  ...
  public void paint(Graphics g){
	...
	case tlogData.TYPE_EVENT:
	  ...
	  g.drawLine(x-1,y,x-1,y+BAR_HEIGHT-1);
	  break;
...
class PeNumPanel extends Panel {
  ...
  public void paint(Graphics g){
    ...
    g.setColor(fgc);
    for(int pe = 0; pe < log.npe; pe++){
      int y = pe*tlogDrawPanel.BAR_HEIGHT+fm.getAscent()+2;
      g.drawString("id"+pe,5,y);
    }
  }
}
