static char rcsid[] = "$Id: remote-exec-test1.c,v 1.1.1.1 2004-11-03 21:01:38 yoshihiro Exp $";
/* 
...
main(int argc, char *argv[])
{
    ...
    OmniRpcExecRemote(host,buf,"sin",a1,&a3);
    printf("grpc sin(%g)=%g\n",a1,a3);
    ...
    OmniRpcExecRemote(host,buf,"mmul",N,A,B,D);
